        ...
        <el-tabs type="border-card">
          <el-tab-pane>
            ...
            <div class="p20" style="border-top: 1px solid #ededed">
              <div style="width: 676px;margin: 0 auto;color: #409EFF">事项信息：</div>
              ...
              <!-- 未立案不展示案件信息 -->
              <div v-if="info.caseStatus != null">
                <div style="width: 676px;margin: 0 auto;color: #409EFF; margin-top: 10px">案件信息：</div>
                <table border="1" cellspacing="0" style="margin: 0 auto">
                  <tr>
                    <td>案件编号：</td>
                    <td>{{info.caseNo}}</td>
